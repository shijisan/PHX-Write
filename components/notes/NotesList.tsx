    ...
    <>
      <ul className="grid md:grid-cols-4 md:gap-8 gap-4 quill-texts">
        {notes.length == 0 ? (
          ...
          notes.map((note) => (
            <li
              className="bg-indigo-500/50 rounded-md md:p-8 p-4 hover:cursor-pointer hover:brightness-110 hover:scale-105 transition-all flex-col border border-indigo-50/50"
